...
public class ManagedFileApi {
  ...
  public record OnboardRequest(@NotBlank String sourceId,@NotBlank String name,@NotBlank String owner,@NotBlank String targetClassIri,@NotEmpty List<String> semanticRefs,List<String> sourceObjectKeyFields,List<FieldDecision> fields){}
