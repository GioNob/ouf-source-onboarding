...
alter table ouf_onboarding.managed_file_asset add constraint managed_file_asset_media_type_check check(media_type in ('text/csv','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','application/geopackage+sqlite3'));
